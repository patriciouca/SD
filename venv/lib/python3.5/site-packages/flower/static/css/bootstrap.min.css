 ...
 *
 * Designed and built with all the love in the world @twitter.py by @mdo and @fat.
 */
...
a{color:#348613;text-decoration:none;}
a:hover{color:#59b833;text-decoration:underline;}
...
.table{width:100%;margin-bottom:18px;}.table th,.table td{padding:8px;line-height:18px;text-align:left;vertical-align:top;border-top:1px solid #c7ecb8;}
.table th{font-weight:bold;}
.table thead th{vertical-align:bottom;}
.table caption+thead tr:first-child th,.table caption+thead tr:first-child td,.table colgroup+thead tr:first-child th,.table colgroup+thead tr:first-child td,.table thead:first-child tr:first-child th,.table thead:first-child tr:first-child td{border-top:0;}
.table tbody+tbody{border-top:2px solid #c7ecb8;}
.table-condensed th,.table-condensed td{padding:4px 5px;}
.table-bordered{border:1px solid #c7ecb8;border-collapse:separate;*border-collapse:collapsed;border-left:0;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;}.table-bordered th,.table-bordered td{border-left:1px solid #c7ecb8;}
...
.table-striped tbody tr:nth-child(odd) td,.table-striped tbody tr:nth-child(odd) th{background-color:#f0ffeb;}
...
.btn-primary{background-color:#288613;background-image:-moz-linear-gradient(top, #348613, #178613);background-image:-ms-linear-gradient(top, #348613, #178613);background-image:-webkit-gradient(linear, 0 0, 0 100%, from(#348613), to(#178613));background-image:-webkit-linear-gradient(top, #348613, #178613);background-image:-o-linear-gradient(top, #348613, #178613);background-image:linear-gradient(top, #348613, #178613);background-repeat:repeat-x;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#348613', endColorstr='#178613', GradientType=0);border-color:#178613 #178613 #0c4309;border-color:rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);*background-color:#178613;filter:progid:DXImageTransform.Microsoft.gradient(enabled = false);}.btn-primary:hover,.btn-primary:active,.btn-primary.active,.btn-primary.disabled,.btn-primary[disabled]{background-color:#178613;*background-color:#137010;}
.btn-primary:active,.btn-primary.active{background-color:#0f590d \9;}
...
.btn-group.open .btn-primary.dropdown-toggle{background-color:#178613;}
...
.nav-list>.active>a,.nav-list>.active>a:hover{color:#ffffff;text-shadow:0 -1px 0 rgba(0, 0, 0, 0.2);background-color:#348613;}
...
.nav-pills>.active>a,.nav-pills>.active>a:hover{color:#ffffff;background-color:#348613;}
...
.nav-tabs .dropdown-toggle .caret,.nav-pills .dropdown-toggle .caret{border-top-color:#348613;border-bottom-color:#348613;margin-top:6px;}
.nav-tabs .dropdown-toggle:hover .caret,.nav-pills .dropdown-toggle:hover .caret{border-top-color:#59b833;border-bottom-color:#59b833;}
...
.navbar-inner{min-height:40px;padding-left:20px;padding-right:20px;background-color:#81a64f;background-image:-moz-linear-gradient(top, #5b8933, #bad279);background-image:-ms-linear-gradient(top, #5b8933, #bad279);background-image:-webkit-gradient(linear, 0 0, 0 100%, from(#5b8933), to(#bad279));background-image:-webkit-linear-gradient(top, #5b8933, #bad279);background-image:-o-linear-gradient(top, #5b8933, #bad279);background-image:linear-gradient(top, #5b8933, #bad279);background-repeat:repeat-x;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#5b8933', endColorstr='#bad279', GradientType=0);-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.25), inset 0 -1px 0 rgba(0,0,0,.1);-moz-box-shadow:0 1px 3px rgba(0,0,0,.25), inset 0 -1px 0 rgba(0,0,0,.1);box-shadow:0 1px 3px rgba(0,0,0,.25), inset 0 -1px 0 rgba(0,0,0,.1);}
.navbar .container{width:auto;}
.nav-collapse.collapse{height:auto;}
.navbar{color:#f2fcee;}.navbar .brand:hover{text-decoration:none;}
.navbar .brand{float:left;display:block;padding:8px 20px 12px;margin-left:-20px;font-size:20px;font-weight:200;line-height:1;color:#f2fcee;}
.navbar .navbar-text{margin-bottom:0;line-height:40px;}
.navbar .navbar-link{color:#f2fcee;}.navbar .navbar-link:hover{color:#ffffff;}
...
.navbar-search{position:relative;float:left;margin-top:6px;margin-bottom:0;}.navbar-search .search-query{padding:4px 9px;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:1;color:#ffffff;background-color:#ebf2d8;border:1px solid #b0cc66;-webkit-box-shadow:inset 0 1px 2px rgba(0,0,0,.1), 0 1px 0 rgba(255,255,255,.15);-moz-box-shadow:inset 0 1px 2px rgba(0,0,0,.1), 0 1px 0 rgba(255,255,255,.15);box-shadow:inset 0 1px 2px rgba(0,0,0,.1), 0 1px 0 rgba(255,255,255,.15);-webkit-transition:none;-moz-transition:none;-ms-transition:none;-o-transition:none;transition:none;}.navbar-search .search-query:-moz-placeholder{color:#cccccc;}
...
.navbar .nav>li>a{float:none;padding:9px 10px 11px;line-height:19px;color:#f2fcee;text-decoration:none;text-shadow:0 -1px 0 rgba(0, 0, 0, 0.25);}
...
.navbar .nav .active>a,.navbar .nav .active>a:hover{color:#ffffff;text-decoration:none;background-color:#bad279;}
.navbar .divider-vertical{height:40px;width:1px;margin:0 9px;overflow:hidden;background-color:#bad279;border-right:1px solid #5b8933;}
.navbar .nav.pull-right{margin-left:10px;margin-right:0;}
.navbar .btn-navbar{display:none;float:right;padding:7px 10px;margin-left:5px;margin-right:5px;background-color:#81a64f;background-image:-moz-linear-gradient(top, #5b8933, #bad279);background-image:-ms-linear-gradient(top, #5b8933, #bad279);background-image:-webkit-gradient(linear, 0 0, 0 100%, from(#5b8933), to(#bad279));background-image:-webkit-linear-gradient(top, #5b8933, #bad279);background-image:-o-linear-gradient(top, #5b8933, #bad279);background-image:linear-gradient(top, #5b8933, #bad279);background-repeat:repeat-x;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#5b8933', endColorstr='#bad279', GradientType=0);border-color:#bad279 #bad279 #9cbf40;border-color:rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);*background-color:#bad279;filter:progid:DXImageTransform.Microsoft.gradient(enabled = false);-webkit-box-shadow:inset 0 1px 0 rgba(255,255,255,.1), 0 1px 0 rgba(255,255,255,.075);-moz-box-shadow:inset 0 1px 0 rgba(255,255,255,.1), 0 1px 0 rgba(255,255,255,.075);box-shadow:inset 0 1px 0 rgba(255,255,255,.1), 0 1px 0 rgba(255,255,255,.075);}.navbar .btn-navbar:hover,.navbar .btn-navbar:active,.navbar .btn-navbar.active,.navbar .btn-navbar.disabled,.navbar .btn-navbar[disabled]{background-color:#bad279;*background-color:#b0cc66;}
.navbar .btn-navbar:active,.navbar .btn-navbar.active{background-color:#a6c553 \9;}
...
a.thumbnail:hover{border-color:#348613;-webkit-box-shadow:0 1px 4px rgba(0, 105, 214, 0.25);-moz-box-shadow:0 1px 4px rgba(0, 105, 214, 0.25);box-shadow:0 1px 4px rgba(0, 105, 214, 0.25);}
...
.dropdown-menu li>a:hover,.dropdown-menu .active>a,.dropdown-menu .active>a:hover{color:#ffffff;text-decoration:none;background-color:#348613;}
